...
function init() {
	...
	// Creando objetos
	cub1 = crear_cubos(50, 20, 100, 0xeee);
	cub1.position.set(0, 20, 0);
	scene.add(cub1);


	rueda1 = crear_cilindro(10, 10, 10, 0xfff);
	rueda1.rotation.z = 33.005;
	rueda1.position.set(-25, -10, 25);
	cub1.add(rueda1);

	rueda2 = crear_cilindro(10, 10, 10, 0xfff);
	rueda2.rotation.z = 33.005;
	rueda2.position.set(-25, -10, -25);
	cub1.add(rueda2);

	rueda3 = crear_cilindro(10, 10, 10, 0xff0);
	rueda3.rotation.z = 33.005;
	rueda3.position.set(25, -10, 25);
	cub1.add(rueda3);

	rueda4 = crear_cilindro(10, 10, 10, 0xff0);
	rueda4.rotation.z = 33.005;
	rueda4.position.set(25, -10, -25);
	cub1.add(rueda4);
